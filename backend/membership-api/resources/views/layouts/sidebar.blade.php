@php
    $nav = [
        ...
        ['members.*', 'members.index', 'users', 'Member'],
        ['rooms.*', 'rooms.index', 'door-open', 'Ruangan'],
        ['outlets.*', 'outlets.index', 'store', 'Outlet'],
        ['topups.*', 'topups.index', 'wallet-cards', 'Top Up Saldo'],
        ['scan.*', 'scan.index', 'scan-line', 'Scan NFC'],
        ['transactions.*', 'transactions.index', 'receipt-text', 'Transaksi'],
        ['accesses.*', 'accesses.index', 'history', 'Riwayat Akses'],
        ['admins.*', 'admins.index', 'shield-user', 'Admin'],
